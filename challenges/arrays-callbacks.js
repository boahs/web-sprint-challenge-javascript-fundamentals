...
create a new array of objects called lowPopulationAnimals which contains only the 
...
zooAnimals.reduce((acum, reducedPop) => populationTotal = acum + reducedPop.population,0) //remember to add index
